...
| リリース準備 | `/admin/release` | システム管理 | リリース前チェック | 環境/マイグレーション/権限/Runbook導線 | admin-release-branding / admin-release-templates / admin-release-env-templates / admin-release-evidence-link |
