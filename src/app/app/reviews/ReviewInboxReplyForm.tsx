  ...
  return (
    <form action={action} className="space-y-3">
      ...
      <textarea
        ...
        rows={3}
        placeholder="返信内容を入力"
        className="w-full rounded-md border border-slate-200 bg-white p-3 text-sm text-slate-700 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-400"
