        ...
        <Card>
          <CardContent className="space-y-4 text-sm leading-relaxed text-[color:var(--text-default)]">
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-[color:var(--text-strong)]">1. 適用</h2>
              <p>本規約は TEPPEN MEO を利用するすべてのユーザーに適用されます。</p>
            </section>

            <section className="space-y-2">
              <h2 className="text-base font-semibold text-[color:var(--text-strong)]">2. アカウント</h2>
              <p>ユーザーは正確な情報でアカウントを作成し、認証情報を適切に管理するものとします。</p>
            </section>

            <section className="space-y-2">
              <h2 className="text-base font-semibold text-[color:var(--text-strong)]">3. 禁止事項</h2>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-[color:var(--text-strong)]">4. 免責</h2>
              <p>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-[color:var(--text-strong)]">5. 契約解除</h2>
              <p>利用規約違反があった場合、アカウント停止または利用停止措置を行うことがあります。</p>
            </section>

            <section className="space-y-2">
              <h2 className="text-base font-semibold text-[color:var(--text-strong)]">6. 準拠法</h2>
              <p>本規約は日本法に準拠します。紛争は日本の裁判所を第一審の専属的合意管轄とします。</p>
            </section>

            <section className="space-y-2">
              <h2 className="text-base font-semibold text-[color:var(--text-strong)]">7. お問い合わせ</h2>
            ...
            <section className="space-y-2">
              <h2 className="text-base font-semibold text-[color:var(--text-strong)]">8. 施行日</h2>
              <p className="text-sm text-[color:var(--text-default)]">
