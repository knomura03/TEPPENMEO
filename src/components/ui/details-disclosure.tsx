...
export function DetailsDisclosure({
  ...
  const summaryTone =
    tone === "dark"
      ...
      : "text-[color:var(--text-default)] hover:text-[color:var(--text-strong)] hover:bg-[color:var(--surface-muted)] group-open:text-[color:var(--text-strong)]";
  const contentTone =
    tone === "dark"
      ? "border-slate-800 bg-slate-950 text-slate-200"
      : "border-[color:var(--border)] bg-[color:var(--surface-muted)] text-[color:var(--text-default)]";
  const labelTone =
    tone === "dark" ? "text-slate-400" : "text-[color:var(--text-muted)]";
